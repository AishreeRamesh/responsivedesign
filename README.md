    ...
    <div class="container">
        <div class="row align-items-end">
            <div class="col text-center">
                Copyright © 2020 Silicon Private Limited, Developed by Aishree Ramesh.
            </div>
        </div>
    </div>
    <!-- Optional JavaScript -->
...
{% block content %}
<div class="card">
  <img class="card-img-top" src="/static/img/hd1.jpg" alt="Card image cap">
  <div class="card-body">
...
<div class="row text-center">
    ...
    <div class="card col-12 col-md-6 col-lg-3">
    <img class="card-img-top" src="/static/img/ram4.jpg" alt="Card image cap">
    <div class="card-body">
    ...
    <div class="card col-12 col-md-6 col-lg-3">
    <img class="card-img-top" src="/static/img/ram5.jpg" alt="Card image cap">
    <div class="card-body">
    ...
    <div class="card col-12 col-md-6 col-lg-3">
    <img class="card-img-top" src="/static/img/ram6.jpg" alt="Card image cap">
    <div class="card-body">
    ...
    <div class="card col-12 col-md-6 col-lg-3">
    <img class="card-img-top" src="/static/img/ram7.jpg" alt="Card image cap">
    <div class="card-body">
    ...
    <div class="card col-12 col-md-6 col-lg-3">
    <img class="card-img-top" src="/static/img/ram8.jpg" alt="Card image cap">
    <div class="card-body">
    ...
    <div class="card col-12 col-md-6 col-lg-3">
    <img class="card-img-top" src="/static/img/ram9.jpg" alt="Card image cap">
    <div class="card-body">
    ...
    <div class="card col-12 col-md-6 col-lg-3">
    <img class="card-img-top" src="/static/img/ram10.jpg" alt="Card image cap">
    <div class="card-body">
    ...
    <div class="card col-12 col-md-6 col-lg-3">
    <img class="card-img-top" src="/static/img/ram11.jpg" alt="Card image cap">
    <div class="card-body">
    ...
    <div class="card col-12 col-md-6 col-lg-3">
    <img class="card-img-top" src="/static/img/ram12.jpg" alt="Card image cap">
    <div class="card-body">
...
<div class="row text-center">
    ...
    <div class='row text-center'>
        <div class="card col-12 col-md-6 col-lg-4">
            <div class="card">
                <img class="card-img" src="/static/img/a1.jpg" alt="Card image">
            </div>
                ...
                <blockquote class="blockquote mb-0">
                    ...
                    <footer class="blockquote-footer">
                        <small class="text-muted">
                            <b>President</b> <cite title="Source Title">of Silicon pvt. ltd</cite>
                        </small>
                    </footer>
                </blockquote>
            </div>
        ...
        <div class="card col-12 col-md-6 col-lg-4">
            <div class="card">
                <img class="card-img" src="/static/img/a2.jpg" alt="Card image">
            </div>
            <div class="card p-3 text-right">
                <blockquote class="blockquote mb-0">
                    <p>Zhou Shen</p>
                    <footer class="blockquote-footer">
                        <small class="text-muted">
                            <b>Vice President</b> <cite title="Source Title">of Silicon pvt. ltd</cite>
                        </small>
                    </footer>
                </blockquote>
            </div>
        ...
        <div class="card col-12 col-md-6 col-lg-4">
            <div class="card">
                <img class="card-img" src="/static/img/a3.jpg" alt="Card image">
            </div>
            <div class="card p-3 text-right">
                <blockquote class="blockquote mb-0">
                    <p>Kana Nishino</p>
                    <footer class="blockquote-footer">
                        <small class="text-muted">
                            <b>Cheif Operating Officer</b> <cite title="Source Title">of Silicon pvt. ltd</cite>
                        </small>
                    </footer>
                </blockquote>
            </div>
        ...
        <div class="card col-12 col-md-6 col-lg-4">
            <div class="card">
                <img class="card-img" src="/static/img/a4.jpg" alt="Card image">
            </div>
            <div class="card p-3 text-right">
                <blockquote class="blockquote mb-0">
                    <p>Bongyoung Park</p>
                    <footer class="blockquote-footer">
                        <small class="text-muted">
                            <b>Cheif Technical Officer</b> <cite title="Source Title">of Silicon pvt. ltd</cite>
                        </small>
                    </footer>
                </blockquote>
            </div>
        ...
        <div class="card col-12 col-md-6 col-lg-4">
            <div class="card">
                <img class="card-img" src="/static/img/a5.jpg" alt="Card image">
            </div>
            <div class="card p-3 text-right">
                <blockquote class="blockquote mb-0">
                    <p>Tate Mcrae</p>
                    <footer class="blockquote-footer">
                        <small class="text-muted">
                            <b>Design Lead</b> <cite title="Source Title">of Silicon pvt. ltd</cite>
                        </small>
                    </footer>
                </blockquote>
            </div>
        ...
        <div class="card col-12 col-md-6 col-lg-4">
            <div class="card">
                <img class="card-img" src="/static/img/a6.png" alt="Card image">
            </div>
            <div class="card p-3 text-right">
                <blockquote class="blockquote mb-0">
                    <p>Anna Akana</p>
                    <footer class="blockquote-footer">
                        <small class="text-muted">
                           <b>Marketing Lead</b><cite title="Source Title">of Silicon pvt. ltd</cite>
                        </small>
                    </footer>
                </blockquote>
            </div>
        ...
        <div class="card col-12 col-md-6 col-lg-4">
            <div class="card">
                <img class="card-img" src="/static/img/a7.jpg" alt="Card image">
            </div>
            <div class="card p-3 text-right">
                <blockquote class="blockquote mb-0">
                    <p>Koosung Jung</p>
                    <footer class="blockquote-footer">
                        <small class="text-muted">
                           <b>Legal Officer</b><cite title="Source Title">of Silicon pvt. ltd</cite>
                        </small>
                    </footer>
                </blockquote>
            </div>
...
<div class="card">
  ...
  <div class="card-body">
    ...
    <p class="card-text">
        <hr>
        <div class="col text-center">
        <h4 class="lead">Email: dougalhenderson@gmail.silicon.in</h4><br>
        <h4 class="lead">Phone: +91 9837476483</h4><br>
        <h4 class="lead">Address: Silican pvt Ltd. Beverly Hills, LA</h4>
        </div>
        <hr>
  </div>
</div>
